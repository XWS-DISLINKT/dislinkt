...
var file_post_service_proto_rawDesc = []byte{
	...
	0x52, 0x08, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x32, 0xfc, 0x05, 0x0a, 0x0b, 0x50,
	...
	0x7d, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x42, 0x2e, 0x5a, 0x2c, 0x67, 0x69, 0x74,
...
var file_post_service_proto_depIdxs = []int32{
	...
	4,  // 19: post.PostService.Get:output_type -> post.GetResponse
	6,  // 20: post.PostService.GetAll:output_type -> post.GetAllResponse
	8,  // 21: post.PostService.Post:output_type -> post.PostResponse
	6,  // 22: post.PostService.GetByUser:output_type -> post.GetAllResponse
	10, // 23: post.PostService.LikePost:output_type -> post.ReactionResponse
	10, // 24: post.PostService.DislikePost:output_type -> post.ReactionResponse
	12, // 25: post.PostService.CommentPost:output_type -> post.CommentResponse
	13, // 26: post.PostService.GetAllReactionsByPost:output_type -> post.AllReactionsResponse
	14, // 27: post.PostService.GetAllCommentsByPost:output_type -> post.AllCommentsResponse
