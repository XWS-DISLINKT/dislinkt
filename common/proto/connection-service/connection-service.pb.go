...
func (x *ConnectionResponse) GetSuccess() string {
	if x != nil {
		return x.Success
	}
	return ""
...
var file_connection_service_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0x68, 0x0a,
	...
	0x65, 0x69, 0x76, 0x65, 0x72, 0x49, 0x64, 0x32, 0x9b, 0x01, 0x0a, 0x11, 0x43, 0x6f, 0x6e, 0x6e,
	...
	0x6e, 0x42, 0x6f, 0x64, 0x79, 0x42, 0x34, 0x5a, 0x32, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_connection_service_proto_depIdxs = []int32{
	...
	1, // 2: connection.ConnectionService.MakeConnectionWithPublicProfile:output_type -> connection.ConnectionResponse
